 ...
 * @author JiaweiMao
 * @version 1.0.0
 * @since 04 Apr 2018, 6:54 PM
 */
public class SeparatorEx1 extends Application
{
    ...
    public void start(Stage stage)
    {
        ...
        scene.setRoot(grid);
        scene.getStylesheets().add("css/controlStyle2.css");

        Image cloudImage = new Image(
                getClass().getClassLoader().getResourceAsStream("cloud.jpg")
        );
        Image sunImage = new Image(
                getClass().getClassLoader().getResourceAsStream("sun.jpg")
        );
