 ...
 * @author JiaweiMao
 * @version 1.0.0
 * @since 04 Apr 2018, 7:16 PM
 */
public class TreeViewEx1 extends Application
{

    private final Node rootIcon = new ImageView(new Image(getClass().getClassLoader().getResourceAsStream("root.png")));
    private final Image depIcon = new Image(getClass().getClassLoader().getResourceAsStream("department.png"));
