package trail.jgui.swing.border;
...
public class BorderDemo extends JPanel {
	...
	private static final long serialVersionUID = -5676979114459731073L;
	...
	public BorderDemo() {
		...
		ImageIcon icon = createImageIcon("wavy.gif", "wavy-line border icon"); // 20x22
