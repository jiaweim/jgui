package trail.jgui.swing.components;
...
public class BorderDemo extends JPanel {
    ...
    public BorderDemo() {
        ...
        //A border that puts 10 extra pixels at the sides at bottom of each pane.
        ...
        String toolTip = "<html>Blue Wavy Line border art crew:<br>&nbsp;&nbsp;&nbsp;Bill Pauley<br>&nbsp;" +
                "&nbsp;&nbsp;Cris St. Aubyn<br>&nbsp;&nbsp;&nbsp;Ben Wronsky<br>&nbsp;&nbsp;&nbsp;Nathan " +
                "Walrath<br>&nbsp;&nbsp;&nbsp;Tommy Adams, special consultant</html>";
