...
public class NodeBoundsApp extends Application
{
    ...
    ObservableList<String> colorList =
            FXCollections.observableArrayList("BLUE", "DARKBLUE", "DARKGRAY", "DARKRED", "GRAY", "GREEN", "RED",
                    "PURPLE",
                    "YELLOW", "BLACK");
    ...
    Polygon localXArrow =
            new Polygon(AXIS_LENGTH, -ARROW_LENGTH, AXIS_LENGTH, ARROW_LENGTH, AXIS_LENGTH + ARROW_LENGTH, 0,
                    AXIS_LENGTH,
                    -ARROW_LENGTH);
    ...
    public void start(Stage stage)
    {
        ...
        parent.getChildren().addAll(new Group(localXAxisGroup, localYAxisGroup),
                ...
                new Group(localBoundsRect, LOCAL_BOUNDS_PATH_CIRCLE), new Group(layoutBoundsRect,
                        LAYOUT_BOUNDS_PATH_CIRCLE),
                new Group(mainRect));
    ...
    private void bindLabelsToSliders()
    {
        ...
        widthLabel.textProperty().bind(new SimpleStringProperty("width:").concat(widthSlider.valueProperty().asString
                ("%.2f")));
        heightLabel.textProperty().bind(new SimpleStringProperty("height:").concat(heightSlider.valueProperty()
                .asString("%.2f")));
        opacityLabel.textProperty().bind(new SimpleStringProperty("opacity:").concat(opacitySlider.valueProperty()
                .asString("%.2f")));
        strokeLabel.textProperty().bind(new SimpleStringProperty("stroke:").concat(strokeSlider.valueProperty()
                .asString("%.2f")));

        translateXLabel.textProperty().bind(new SimpleStringProperty("TranslateX:").concat(translateXSlider
                .valueProperty().asString("%.2f")));
        translateYLabel.textProperty().bind(new SimpleStringProperty("TranslateY:").concat(translateYSlider
                .valueProperty().asString("%.2f")));

        rotateLabel.textProperty().bind(new SimpleStringProperty("Rotate:").concat(rotateSlider.valueProperty()
                .asString("%.2f")).concat(" deg"));

        scaleXLabel.textProperty().bind(new SimpleStringProperty("ScaleX:").concat(scaleXSlider.valueProperty()
                .asString("%.2f")));
        scaleYLabel.textProperty().bind(new SimpleStringProperty("ScaleY:").concat(scaleYSlider.valueProperty()
                .asString("%.2f")));

        shearXLabel.textProperty().bind(new SimpleStringProperty("ShearX:").concat(shearXSlider.valueProperty()
                .asString("%.2f")));
        shearYLabel.textProperty().bind(new SimpleStringProperty("ShearY:").concat(shearYSlider.valueProperty()
                .asString("%.2f")));
    }
    ...
    private VBox getTransformationControls()
    {
        ...
        xyBox.setSpacing(5);
        VBox v1 = new VBox();
        v1.getChildren().addAll(xLabel, xSlider);
        VBox v2 = new VBox();
        v2.getChildren().addAll(yLabel, ySlider);
        xyBox.getChildren().addAll(v1, v2);

        HBox whBox = new HBox();
        whBox.setSpacing(5);
        VBox v3 = new VBox();
        v3.getChildren().addAll(widthLabel, widthSlider);
        VBox v4 = new VBox();
        v4.getChildren().addAll(heightLabel, heightSlider);
        whBox.getChildren().addAll(v3, v4);

        HBox colorBox = new HBox();
        colorBox.setSpacing(5);
        VBox v5 = new VBox();
        v5.getChildren().addAll(strokeLabel, strokeSlider);
        VBox v6 = new VBox();
        v6.getChildren().addAll(new Label("Stroke Color"), rectStrokeColorChoiceBox);
        colorBox.getChildren().addAll(v5, v6);

        HBox opacityBox = new HBox();
        opacityBox.setSpacing(5);
        VBox v7 = new VBox();
        v7.getChildren().addAll(opacityLabel, opacitySlider);
        VBox v8 = new VBox();
        v8.getChildren().addAll(new Label("Fill Color"), rectFillColorChoiceBox);
        opacityBox.getChildren().addAll(v7, v8);


        HBox translateBox = new HBox();
        translateBox.setSpacing(5);
        VBox v9 = new VBox();
        v9.getChildren().addAll(translateXLabel, translateXSlider);
        VBox v10 = new VBox();
        v10.getChildren().addAll(translateYLabel, translateYSlider);

        translateBox.getChildren().addAll(v9, v10);

        HBox rotateBox = new HBox();
        rotateBox.setSpacing(5);
        VBox v11 = new VBox();
        v11.getChildren().addAll(rotateLabel, rotateSlider);
        rotateBox.getChildren().addAll(v11);

        HBox scaleBox = new HBox();
        scaleBox.setSpacing(5);
        VBox v12 = new VBox();
        v12.getChildren().addAll(scaleXLabel, scaleXSlider);
        VBox v13 = new VBox();
        v13.getChildren().addAll(scaleYLabel, scaleYSlider);
        scaleBox.getChildren().addAll(v12, v13);

        HBox shearBox = new HBox();
        shearBox.setSpacing(5);
        VBox v14 = new VBox();
        v14.getChildren().addAll(shearXLabel, shearXSlider);
        VBox v15 = new VBox();
        v15.getChildren().addAll(shearYLabel, shearYSlider);
        shearBox.getChildren().addAll(v14, v15);
