...
public class Tab2Controller
{
    ...
    public void btn2SaveClicked(ActionEvent actionEvent)
    {
        System.out.println("Btn 2 save clicked");
        lbl2.setText(txt2.getText());
    }

    public void btn2LoadClicked(ActionEvent actionEvent)
    {
        System.out.println("Btn 2 load clicked");
        lbl2.setText(mainController.loadLbl1TextFromTab1());
    }
}
