...
package jgui.swing.j2d.geometry;
...
class CurveApplet extends JPanel {
	...
	class CurvePane extends JComponent {
		public CurvePane() {
			...
			cubicCurve = new CubicCurve2D.Double(startC.x, startC.y, controlStart.x, controlStart.y, controlEnd.x,
					controlEnd.y, endC.x, endC.y);
		}
	...
	class Marker {
		...
		/**
		 * The center of the control circle
		 */
