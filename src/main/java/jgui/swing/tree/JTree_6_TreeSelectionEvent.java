...
public class JTree_6_TreeSelectionEvent implements TreeModelListener, TreeSelectionListener {
	...
	public JTree_6_TreeSelectionEvent() {
		...
		tree.addMouseListener(new MouseHandler());// 使Tree加入检测Mouse事件，以便取得节点名称
	...
	public static void main(String args[]) {
		new JTree_6_TreeSelectionEvent();
	}
}
